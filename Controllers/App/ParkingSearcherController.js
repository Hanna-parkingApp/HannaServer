...
async function parkingController(req, res) {
    ...
    try {
        ...
        // const createDemoParking = await createUserParking(demoParking1);
        // console.log(createDemoParking);
 
        
 
        //const nearbyParking = await getUserParking({timeStamp: {$gte: arrivalTime , $lte : arrivalTime + 4 * 60000 }, generalLocation: generalLoc})
        const nearbyParking = await getUserParking({generalLocation: generalLoc})
        console.log("nearbyParking: ", nearbyParking);
